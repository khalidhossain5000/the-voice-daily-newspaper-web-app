    ...
    return (
        <div className='bg-[#030b13] py-12 lg:py-24'>
            <div className="max-w-7xl mx-auto">
              ...
              <div className="flex flex-col lg:flex-row  justify-center items-center mt-3 lg:mt-12 gap-6 lg:gap-12">
                <a href="https://facebook.com/" target="_blank">
                    <FaFacebook size={50}  className='text-white hover:text-[#1447e6] transition duration-200' />
                </a>
                <a href="https://x.com/" target="_blank">
                  <BsTwitterX size={50} className='text-white hover:text-[#1447e6] transition duration-200' />
                </a>
                <a href="https://github.com/khalidhossain5000" target="_blank">
                  <FaGithub size={50} className='text-white hover:text-[#1447e6] transition duration-200' />
                </a>
                <a href="https://youtube.com/" target="_blank">
                  <FaYoutube size={50} className='text-white hover:text-[#1447e6] transition duration-200' />
                </a>
                <a href="https://www.linkedin.com/" target="_blank">
                  <FaLinkedin size={50} className='text-white hover:text-[#1447e6] transition duration-200' />
                </a>
              </div>
              <div>
          ...
          <h3 className="text-center text-2xl text-gray-300">
            &copy; <span className="font-bold text-white mx-1">The Voice Daily</span>
            All Rights Reserved
          </h3>
        </div>
                </div>
